...
// 移动cdn.html
   fs.renameSync('../cdn.html','../../cdn.html');
    ...
    //复制文件
    fs.writeFileSync('../../libs/egret.asm.js', fs.readFileSync('../../../../../libs/egret.asm.js'));
    fs.writeFileSync('../../libs/egret.asm.js.mem', fs.readFileSync('../../../../../libs/egret.asm.js.mem'));
    fs.writeFileSync('../../libs/egret.webassembly.js', fs.readFileSync('../../../../../libs/egret.webassembly.js'));
    fs.writeFileSync('../../libs/egret.webassembly.wasm', fs.readFileSync('../../../../../libs/egret.webassembly.wasm'));    
...
function handleHtml() {
    ...
    //给override加版本号
    text = text.replace('override.js', 'override.js?'+version.files['js/override.js']);
