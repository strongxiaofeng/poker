module game {
    ...
    export class BetRecordItem extends eui.AItemRenderer {
        ...
        public constructor() {
            ...
            this.detailHeight = GlobalConfig.isMobile ? 480 : 195;
            this.normalHeight = GlobalConfig.isMobile ? 165 : 70;
            this.skinName = SystemPath.skin_path + "betRecord/betRecordItemSkin.exml";
        }
        ...
        private onTap(e: egret.TouchEvent): void {
            switch (e.target) {
                ...
                case this.imgShowLess:
                    ...
                    break;
                case this.btnVideo:
                    MediatorManager.openMediator(Mediators.Mediator_PbBacMediator, [this.data, Mediators.Mediator_BetRecord]);
                    break;
            }
        }
