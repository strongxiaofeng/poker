module game {
	export class NotifyChatItemPC extends eui.ItemRenderer{
		...
		protected dataChanged()
		{
			...
			if(data.type == 1)
			{
				...
				egret.callLater(()=>{
					this.lableBgImg_r.width = this.lable_r.textWidth + 20;
			...
			else
			{
				...
				egret.callLater(()=>{
					this.lableBgImg_l.width = this.lable_l.textWidth + 20;
