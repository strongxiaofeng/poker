module game {
    ...
    export class QuotaRecordBaseUI extends BaseUI {

        public constructor() {
            super();
            this.skinName = SystemPath.skin_path + "quotaRecord/quotaRecordSkin.exml";
        }
        ...
        /** 分割线 */
        protected imgSeparate: eui.Image;
        /** 交易类型title */
        protected labelTransferTitle: eui.ALabel;
        /** 交易额度 */
        protected labelTransfer: eui.BitmapLabel;
        /** 账户余额title */
        protected labelBalanceTitle: eui.ALabel;
        /** 账户余额 */
        protected labelBalance: eui.BitmapLabel;
        /** 居中显示的账户余额title */
        protected labelBalanceTitleMid: eui.ALabel;
        /** 居中显示的账户余额 */
        protected labelBalanceMid: eui.BitmapLabel;
        ...
        /** 转入 */
        protected labelTransferIn: eui.ALabel;
        /** 转出 */
        protected labelTransferOut: eui.ALabel;
        /** 派彩 */
        protected labelPayout: eui.ALabel;
        /** 打赏 */
        protected labelReward: eui.ALabel;
        /** 投注 */
        protected labelBet: eui.ALabel;
        /** 退还投注 */
        protected labelRefund: eui.ALabel;
        ...
        protected initDisplay(): void {
            ...
            this.listRecord.itemRenderer = QuotaRecordItem;
            ...
            this.listLoader.setList(this.scrollerRecord, () => {
                this.dispatchEventWith(QuotaRecordMediator.LoadMore);
            }, this, () => {
                this.dispatchEventWith(QuotaRecordMediator.Refresh);
            });
        }
        ...
        /** 收到mediator的通知 */
        public onMediatorCommand(type: QuotaRecordUICommands, params: any = null): void {
            switch (type) {
        ...
        /** 注册事件监听器 */
        protected initListener(mediator: QuotaRecordMediator): void {
            ...
            this.registerEvent(this, QuotaRecordMediator.SearchType, mediator.onSearchType, mediator);
            this.registerEvent(this, QuotaRecordMediator.SearchTime, mediator.onSearchTime, mediator);
            this.registerEvent(this, QuotaRecordMediator.LoadMore, mediator.onLoadMore, mediator);
            this.registerEvent(this, QuotaRecordMediator.Refresh, mediator.onRefresh, mediator);
        }
        ...
        /** 打开或关闭日历 */
        protected setCalendar(mediator: QuotaRecordMediator): void {
        ...
        /** 刷新列表 */
        protected updateList(data: topic.TransferHistory): void {
