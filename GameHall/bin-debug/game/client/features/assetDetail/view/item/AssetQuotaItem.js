...
var game;
(function (game) {
    var AssetQuotaItem = (function (_super) {
        __extends(AssetQuotaItem, _super);
        function AssetQuotaItem() {
            var _this = _super.call(this) || this;
            _this.onStage().then(function () {
                _this.init();
            }).catch(function () { });
            _this.skinName = game.SystemPath.skin_path + "assetDetail/assetQuotaItemSkin.exml";
            return _this;
        }
        AssetQuotaItem.prototype.onStage = function () {
            var _this = this;
        ...
        AssetQuotaItem.prototype.dataChanged = function () {
        };
        // ----------------------------------------------- variables -----------------------------------------------
        // ----------------------------------------------- handle data -----------------------------------------------
        AssetQuotaItem.prototype.init = function () {
        ...
        return AssetQuotaItem;
    }(eui.AItemRenderer));
    game.AssetQuotaItem = AssetQuotaItem;
    __reflect(AssetQuotaItem.prototype, "game.AssetQuotaItem");
})(game || (game = {}));
//# sourceMappingURL=AssetQuotaItem.js.map