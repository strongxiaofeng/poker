...
var game;
(function (game) {
    var BetRecordDetailItem = (function (_super) {
        __extends(BetRecordDetailItem, _super);
        function BetRecordDetailItem() {
            var _this = _super.call(this) || this;
            _this.onStage().then(function () {
                _this.init();
            }).catch(function () { });
            _this.skinName = game.SystemPath.skin_path + "betRecord/betRecordDetailItemSkin.exml";
            return _this;
        }
        BetRecordDetailItem.prototype.onStage = function () {
            var _this = this;
        ...
        BetRecordDetailItem.prototype.dataChanged = function () {
            try {
                this.init();
            }
            catch (e) { }
        ...
        // ----------------------------------------------- variables -----------------------------------------------
        // ----------------------------------------------- handle data -----------------------------------------------
        BetRecordDetailItem.prototype.init = function () {
        ...
        return BetRecordDetailItem;
    }(eui.AItemRenderer));
    game.BetRecordDetailItem = BetRecordDetailItem;
    __reflect(BetRecordDetailItem.prototype, "game.BetRecordDetailItem");
})(game || (game = {}));
//# sourceMappingURL=BetRecordDetailItem.js.map