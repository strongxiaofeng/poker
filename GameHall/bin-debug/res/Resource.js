...
(function (R) {
    ...
    */
    ...
    R.registerAnalyzer = registerAnalyzer;
    /**
    ...
    R.registerVersionController = registerVersionController;
    /**
    ...
    R.getVersionController = getVersionController;
    /**
    ...
    R.getGroupByName = getGroupByName;
    /**
     ...
     * <br>R.ResourceItem.TYPE_BIN : ArrayBuffer JavaScript primary object
     * <br>R.ResourceItem.TYPE_IMAGE : img Html Object，or egret.BitmapData interface。
     * <br>R.ResourceItem.TYPE_JSON : Object
     * <br>R.ResourceItem.TYPE_SHEET : Object
     ...
     * <br>R.ResourceItem.TYPE_SOUND : HtmlSound Html Object
     * <br>R.ResourceItem.TYPE_TEXT : string
     ...
     * <br>R.ResourceItem.TYPE_BIN : ArrayBuffer JavaScript 原生对象
     * <br>R.ResourceItem.TYPE_IMAGE : img Html 对象，或者 egret.BitmapData 接口。
     * <br>R.ResourceItem.TYPE_JSON : Object
     * <br>R.ResourceItem.TYPE_SHEET : Object
     ...
     * <br>R.ResourceItem.TYPE_SOUND : HtmlSound Html 对象
     * <br>R.ResourceItem.TYPE_TEXT : string
    ...
    R.setMaxLoadingThread = setMaxLoadingThread;
    /**
    ...
    R.setMaxRetryTimes = setMaxRetryTimes;
    /**
    ...
    var Resource = (function (_super) {
        ...
        Resource.prototype.init = function () {
            this.vcs = new R.VersionController();
            var analyzerClassMap = this.analyzerClassMap;
            analyzerClassMap[R.ResourceItem.TYPE_BIN] = R.BinAnalyzer;
            analyzerClassMap[R.ResourceItem.TYPE_IMAGE] = R.ImageAnalyzer;
            analyzerClassMap[R.ResourceItem.TYPE_TEXT] = R.TextAnalyzer;
            analyzerClassMap[R.ResourceItem.TYPE_JSON] = R.JsonAnalyzer;
            analyzerClassMap[R.ResourceItem.TYPE_SHEET] = R.SheetAnalyzer;
            analyzerClassMap[R.ResourceItem.TYPE_FONT] = R.FontAnalyzer;
            analyzerClassMap[R.ResourceItem.TYPE_SOUND] = R.SoundAnalyzer;
            analyzerClassMap[R.ResourceItem.TYPE_XML] = R.XMLAnalyzer;
            this.resConfig = new R.ResourceConfig();
            this.resLoader = new R.ResourceLoader();
            this.resLoader.callBack = this.onResourceItemComp;
            this.resLoader.resInstance = this;
            this.resLoader.addEventListener(R.ResourceEvent.GROUP_COMPLETE, this.onGroupComp, this);
            this.resLoader.addEventListener(R.ResourceEvent.GROUP_LOAD_ERROR, this.onGroupError, this);
        };
        /**
         * 开始加载配置
         * @method R.loadConfig
        ...
        Resource.prototype.startLoadConfig = function () {
            ...
            for (var i = 0; i < length; i++) {
                ...
                var resItem = new R.ResourceItem(item.url, item.url, item.type);
            ...
            var callback = {
                ...
                onFail: function (err, data) {
                    R.ResourceEvent.dispatchResourceEvent(_this, R.ResourceEvent.CONFIG_LOAD_ERROR);
                }
            };
            if (this.vcs) {
        ...
        Resource.prototype.loadGroup = function (name, priority) {
            ...
            if (this.loadedGroups.indexOf(name) != -1) {
                R.ResourceEvent.dispatchResourceEvent(this, R.ResourceEvent.GROUP_COMPLETE, name);
                return;
            }
        ...
        Resource.prototype.onGroupComp = function (event) {
            if (event.groupName == Resource.GROUP_CONFIG) {
                ...
                R.ResourceEvent.dispatchResourceEvent(this, R.ResourceEvent.CONFIG_COMPLETE);
        ...
        Resource.prototype.onGroupError = function (event) {
            if (event.groupName == Resource.GROUP_CONFIG) {
                this.loadingConfigList = null;
                R.ResourceEvent.dispatchResourceEvent(this, R.ResourceEvent.CONFIG_LOAD_ERROR);
            }
            else {
                this.dispatchEvent(event);
            }
        ...
        Resource.prototype.hasRes = function (key) {
            ...
            if (type == "") {
                var prefix = R.AnalyzerBase.getStringTail(key);
        ...
        Resource.prototype.getRes = function (key) {
            var type = this.resConfig.getType(key);
            if (type == "") {
                var prefix = R.AnalyzerBase.getStringPrefix(key);
                type = this.resConfig.getType(prefix);
                if (type == "") {
                    return null;
                }
        ...
        Resource.prototype.getResByUrl = function (url, compFunc, thisObject, type) {
            ...
            if (this.asyncDic[name]) {
                ...
                this.asyncDic[name] = [args];
                var resItem = new R.ResourceItem(name, url, type);
                this.resLoader.loadItem(resItem);
            }
        };
        /**
        ...
        Resource.prototype.getTypeByUrl = function (url) {
            ...
            var type;
            switch (suffix) {
                case R.ResourceItem.TYPE_XML:
                case R.ResourceItem.TYPE_JSON:
                case R.ResourceItem.TYPE_SHEET:
                    type = suffix;
                    break;
                case "png":
                case "jpg":
                ...
                case "jpeg":
                case "bmp":
                    type = R.ResourceItem.TYPE_IMAGE;
                    break;
                case "fnt":
                    type = R.ResourceItem.TYPE_FONT;
                    break;
                case "txt":
                    type = R.ResourceItem.TYPE_TEXT;
                    break;
                case "mp3":
                case "ogg":
                case "mpeg":
                ...
                case "wma":
                case "mid":
                    type = R.ResourceItem.TYPE_SOUND;
                    break;
                default:
                    type = R.ResourceItem.TYPE_BIN;
                    break;
            }
            return type;
        };
