...
var GestureManager = (function () {
    ...
    GestureManager.prototype._initGesture = function () {
        ...
        this.target.addEventListener(egret.TouchEvent.TOUCH_RELEASE_OUTSIDE, this.onTouched, this);
    ...
    GestureManager.prototype.onTouched = function (e) {
        ...
        if (e.type == egret.TouchEvent.TOUCH_END || e.type == egret.TouchEvent.TOUCH_RELEASE_OUTSIDE) {
            this.removeTouch(e);
        }
